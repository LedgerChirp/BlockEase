			...
			<div className="w-[100vw] h-[100vh]">
				<div className="flex w-[100vw] h-[100vh]">
					<div className="max-w-[22rem] m-auto space-y-10 flex flex-col text-center items-center">
						<h2 className="font-bold text-5xl">Make Ethereum More Accesible</h2>
					...
					<div
						className="m-auto z-0 opacity-40 relative hidden md:opacity-100 md:block"
						dangerouslySetInnerHTML={{ __html: eth_logo }}
					/>
				</div>
			</div>
		</>
